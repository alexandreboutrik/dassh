 ...
 * 1. Opens the compiled bytecode object from embedded memory.
...
int dassh_bpf_init(void) {
	...
	// Use open_mem to load the bytecode from the array generated by xxd
	// (dassh_bpf_o and dassh_bpf_o_len are defined in bytecode.h)
	obj = bpf_object__open_mem(dassh_bpf_o, dassh_bpf_o_len, NULL);
	if (libbpf_get_error(obj)) {
		fprintf(stderr,
				"[C-SHIM] Error: Could not open embedded BPF object.\n");
		return -1;
	}
